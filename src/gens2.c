...
unsigned int gen_ext(unsigned char ext_num, unsigned char cmd, unsigned char b1, unsigned char b2, unsigned char b3) {
  unsigned int out = (0b110u + (((unsigned int)ext_num))) << 29;
